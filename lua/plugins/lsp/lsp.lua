-- get it from https://github.com/nvim-lua/kickstart.nvim/blob/master/init.lua
return {
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        map("gd", tb.lsp_definitions, "Goto Defenition")
        -- WARN: This is not Goto Definition, this is Goto Declaration.
        --  For example, in C this would take you to the header.
        map("gD", vim.lsp.buf.declaration, "Goto Declaration")
        -- Find references for the word under your cursor.
        map("gr", tb.lsp_references, "Goto Reference")
      ...
      lua_ls = {
        ...
        settings = {
          Lua = {
            ...
            -- You can toggle below to ignore Lua_LS's noisy `missing-fields` warnings. If commented - not ignore.
